...
--
-- Host: 127.0.0.1
-- Creato il: Dic 28, 2016 alle 12:47
...
CREATE TABLE `materiale_insegnamenti` (
  `numero_progressivo` int(11) NOT NULL,
...
--
-- Indici per le tabelle `appelli_esami`
--
ALTER TABLE `appelli_esami`
  ADD PRIMARY KEY (`id_apello`);
...
--
ALTER TABLE `evento`
  ADD PRIMARY KEY (`numero_progressivo`);

--
-- Indici per le tabelle `insegnamenti`
--
ALTER TABLE `insegnamenti`
  ADD PRIMARY KEY (`id_insegnamenti`);
