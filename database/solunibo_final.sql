...
--
-- Host: localhost
-- Generation Time: Jan 16, 2017 at 09:43 
...
--
ALTER TABLE `events`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7315800;
--
...
--
ALTER TABLE `storyboard`
  MODIFY `numberID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
ALTER TABLE `teacher`
  MODIFY `numberID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `teachingdoc`
--
ALTER TABLE `teachingdoc`
