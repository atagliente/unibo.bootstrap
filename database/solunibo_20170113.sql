...
INSERT INTO `teacher` (`teacherID`, `email`, `firstName`, `lastName`, `dateOfBirth`, `nationality`, `curriculum`) VALUES
...
--
ALTER TABLE `exam`
  ADD CONSTRAINT `teacher___fk` FOREIGN KEY (`teacher___fk`) REFERENCES `teacher` (`teacherID`);
